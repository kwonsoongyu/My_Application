...
public class Mission_pdf_main_10 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mission_pdf_main10);

        mainFragment = new Mission_pdf_Mainfragment_10();
