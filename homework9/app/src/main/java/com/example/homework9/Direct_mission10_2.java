...
public class Direct_mission10_2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_direct_mission102);
        ...
        btnResult.setOnClickListener(view -> {
            Intent intent = new Intent(getApplicationContext(), Direct_Result_mission10_2.class);
